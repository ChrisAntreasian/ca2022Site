...
describe('Console Utilities', () => {
  describe('cLog', () => {
    it('logs string and value then returns the value', async () => {
      const { cLog } = await import('../../src/lib/console');
    ...
    it('returns the exact same reference for objects', async () => {
      const { cLog } = await import('../../src/lib/console');
    ...
    it('can be chained in functional pipelines', async () => {
      const { cLog } = await import('../../src/lib/console');
    ...
    it('preserves function behavior when used as debugging tool', async () => {
      const { cLog } = await import('../../src/lib/console');
